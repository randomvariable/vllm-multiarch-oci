---
title: Install the DGX Spark 64 KiB kernel driver
description: Build the pinned NVIDIA open-driver fork with DKMS on Ubuntu 24.04 DGX OS arm64.
---

This is the fresh-host path for Ubuntu 24.04 DGX OS on arm64. It combines kernel ABI `7.0.0-1019-nvidia-64k`, NVIDIA userspace and GSP firmware 615.71.09, and the already-patched [`spark-615.71.09` fork](https://github.com/randomvariable/open-gpu-kernel-modules/tree/c5296e2d92f2cdb23cd10df25ec6e989b5f96c42).
...
This follows the fork's [DKMS procedure](https://github.com/randomvariable/open-gpu-kernel-modules/blob/c5296e2d92f2cdb23cd10df25ec6e989b5f96c42/README.md). Register the module, then re-run the pinned kernel package's post-install lifecycle. Ubuntu's kernel hooks invoke DKMS for registered modules before regenerating that kernel's initramfs:
