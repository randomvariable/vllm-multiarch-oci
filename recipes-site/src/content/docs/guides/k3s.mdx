...
description: Bootstrap one k3s server and two GB10 agents with custom CNI and NVIDIA runtime discovery.
---
...
:::caution[Not production-proven here]
The author's accepted TP=2 deployment runs on kubeadm/Cilium, not k3s. These pinned k3s instructions have not completed the GPU/RDMA end-to-end hardware gates.
:::
