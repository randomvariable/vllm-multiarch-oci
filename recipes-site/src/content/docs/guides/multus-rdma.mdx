...
:::caution[Separate network policy]
Cilium policy governs the primary interface; it does not automatically secure the Multus/macvlan interface. Isolate the secondary subnet physically and with host and network controls. I have not run the two-GB10 RDMA transfer on this k3s setup.
:::
...
### Identify the runtime network values
